...
if((i < len)){
var k = (ks[i]);
var G__12781 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12782 = (i + (1));
m = G__12781;
i = G__12782;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12786 = c;
var G__12786__$1 = (((G__12786 == null))?null:G__12786.prototype);
if((G__12786__$1 == null)){
return null;
} else {
return (G__12786__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12790 = c;
var G__12790__$1 = (((G__12790 == null))?null:G__12790.prototype);
if((G__12790__$1 == null)){
return null;
} else {
return (G__12790__$1["render"]);
}
})()));
});
...
var G__12794 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12794) : reagent.impl.component.as_element.call(null,G__12794));
};
...
var _STAR_current_component_STAR_12801 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12801;
}});
...
var G__12809 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__12809) {
...
return ((function (G__12809){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__12812 = reagent.impl.component.state_atom(c);
var G__12813 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__12812,G__12813) : cljs.core.reset_BANG_.call(null,G__12812,G__12813));
});
;})(G__12809))
...
var c = this;
var G__12815_12817 = (c["cljsRatom"]);
if((G__12815_12817 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12815_12817);
}
...
var renders_12820 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12821 = cljs.core.first(cljs.core.vals(renders_12820));
if((cljs.core.count(renders_12820) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_12820))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_12821)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_12821], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}
...
var name__$1 = (function (){var G__12819 = name;
switch (G__12819) {
case "":
...
var elem = (function (){var G__12830 = (function (){var or__6409__auto__ = (function (){var G__12832 = c;
if((G__12832 == null)){
return null;
} else {
return (G__12832["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6409__auto__)){
return or__6409__auto__;
...
return (G__12830["_currentElement"]);
}
})();
var name = (function (){var G__12833 = elem;
var G__12833__$1 = (((G__12833 == null))?null:(G__12833["type"]));
if((G__12833__$1 == null)){
return null;
} else {
return (G__12833__$1["displayName"]);
}
})();
var path = (function (){var G__12834 = elem;
var G__12834__$1 = (((G__12834 == null))?null:(G__12834["_owner"]));
var G__12834__$2 = (((G__12834__$1 == null))?null:reagent$impl$component$component_path(G__12834__$1));
if((G__12834__$2 == null)){
return null;
} else {
return [cljs.core.str(G__12834__$2),cljs.core.str(" > ")].join('');
}
})();
...
var G__12836 = c;
var G__12836__$1 = (((G__12836 == null))?null:G__12836.constructor);
if((G__12836__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12836__$1);
}
}
})();
