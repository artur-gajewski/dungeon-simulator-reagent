...
var G__12866 = o;
(G__12866[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__12868__i < G__12868__a.length) {G__12868__a[G__12868__i] = arguments[G__12868__i + 0]; ++G__12868__i;}
  args = new cljs.core.IndexedSeq(G__12868__a,0);
} 
...
var G__12875 = jsprops;
(G__12875["defaultValue"] = value);

(G__12875["onChange"] = ((function (G__12875,v,value,on_change){
return (function (p1__12872_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12872_SHARP_);
});})(G__12875,v,value,on_change))
);

(G__12875["ref"] = ((function (G__12875,v,value,on_change){
return (function (p1__12873_SHARP_){
return (this$["cljsInputElement"] = p1__12873_SHARP_);
});})(G__12875,v,value,on_change))
);
...
var vec__12882 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12882,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12882,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12882,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___12887 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12887 == null)){
} else {
var key_12888 = temp__4661__auto___12887;
...
var G__12890 = (new reagent.impl.template.NativeWrapper());
(G__12890["name"] = c);
...
var G__12892 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12892) : reagent.impl.template.as_element.call(null,G__12892));
} else {
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12896){
var G__12897 = cljs.core.first(seq12896);
var seq12896__$1 = cljs.core.next(seq12896);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12897,seq12896__$1);
});
...
break;
default:
var G__12904 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12904;
continue;
...
var n__7324__auto___12907 = a.length;
var i_12908 = (0);
while(true){
if((i_12908 < n__7324__auto___12907)){
(a[i_12908] = reagent.impl.template.as_element((a[i_12908])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7324__auto___12910 = a.length;
var i_12911 = (0);
while(true){
if((i_12911 < n__7324__auto___12910)){
var val_12912 = (a[i_12911]);
if((cljs.core.vector_QMARK_(val_12912)) && ((reagent.impl.template.key_from_vec(val_12912) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12911] = reagent.impl.template.as_element(val_12912));

var G__12913 = (i_12911 + (1));
i_12911 = G__12913;
continue;
} else {
}
...
var ctx = ({});
var vec__12917 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12917,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12917,(1),null);
...
var G__12921 = (cljs.core.count(argv) - first_child);
switch (G__12921) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12921){
